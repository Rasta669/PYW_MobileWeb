...
//using System.Collections.Generic;
//using UnityEngine;
//// Additional import for the new Input System
...
//    private void ProcessInput()
//    {
//        // Read the "Move" action value (Vector2 for horizontal/vertical input)
//        Vector2 moveInput = moveAction.ReadValue<Vector2>();
//        horizontalInput = moveInput.x; // We only need the horizontal component for 2D movement
